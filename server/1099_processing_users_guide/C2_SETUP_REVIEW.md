...
8. Enter parameters. The parameters for this process are:
   ...
   - **Control ID**: Use the Control ID for the year in which the process is needing to be run. (e.g., `USO_2022`).
    ![Withhold Sent parameters form](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288148/p15___Control_ID_Use_the_Control_ID_for_the_year_in_wh_cythnl.png)
9. Select `WTHD_SNT` process.
   ![Example of selecting WTHD_SNT process](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288148/p16_Click_OK.__0AVerify_the_process_runs_to_Success_and__rckose.png)
10. Click **OK**.
...
12. In the **Transmitter Information** box, verify the **Supplier Software Indicator** box is checked, as this checkbox must be selected for all USG institutions using PeopleSoft Financials to produce 1099-NEC and 1099-MISC IRS files and Copy B forms.
    ![Transmitter Information form example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288147/p18__s_tax_identification_number_in_the_Tax_ID_field.__bnybfb.png)
...
17. In the **Payer information** box, enter the institution’s name into the **Payer Name 1** field. This is the institution’s name as known for tax purposes.
    ![Payer information form example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288147/p19_r_the_Control_ID_in_the_Control_ID_field._ITS_reco_tlfmhe.png)
...
20. Enter Address and Phone numbers for the Transmitter and the Payer. To add the addresses, click on the envelope icon. To enter phone and fax numbers, click on the telephone icon.
    ![Transmitter address page example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288142/p20_Enter_Address_and_Phone_numb_0Aaddresses__click_on_t_goo7xi.png)
    ![Transmitter phone page example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288141/p20_Click_the_Suppliers_and_Busines_kkgxqy.png)
    ![Payer address page example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288141/p20_rs_for_the_Transmitter_and_the_Payer._To__0Aon._To_e_blzhiq.png)
    ![Payer phone page example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288141/p20_Units_tab._jgbxnt.png)
...
22. Click the **All Suppliers** checkbox to process all withholding Suppliers that are consistent with the business unit specified.
    ![All Suppliers checkbox example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288141/p21_Enter_or_search_for_the_business_unit_in_the_Busin_orrx64.png)
...
25. Deselect the “Process?” checkbox for Piggyback States, as the GeorgiaFIRST model does not use the Piggyback States functionality.
    ![Deselect the “Process” example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288136/p22_Click_the_Save_button_to_save_the_new_Withhold_Con_ekg1ak.png)
