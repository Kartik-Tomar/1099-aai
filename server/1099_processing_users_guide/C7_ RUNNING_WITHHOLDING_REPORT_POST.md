...
9. Depending on the Fiscal Year selected, the user will see specific 1099 Report Selections. Choose the applicable Process Options based on your reporting needs.
   ...
   ![1099 Report Post page, 1099 Report Selections example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288115/p59_commended_Option__as_this_will_print_one_file_to_s_u8wv5n.png)
   ...
   **Other Options**:
   ...
   ![1099 Report Post page, All Files Selections example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288115/p60____0AAll_-_Select_this_option_to_produce_two_electro_vs11vp.png)
...
12. Select “1099 Report Post” to run the `RPT_1099` process Post. Click **OK** to continue.
    ![Run RPT_1099 process Post example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288112/p61_Click_the_Process_Monitor_link.__0AOnce_the_process__jdvchn.png)
13. Click the **Process Monitor** link.
14. Once the process runs to Success, click on `RPT_1099` under the Process Name column.
    ![click on RPT_1099 example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288099/p61_RUNNING_WITHHOLDING_REPORT_POST_step14_xlt9wm.png)
15. Click on the `AP_APY1099` link.
    ![Click on the AP_APY1099 example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288111/p61_on_the_View_LogTrace_link._n8sufh.png)
16. Click on the **View Log/Trace** link.
    ![Click on the View Log/Trace link example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288110/p61_See_page_60_for_the_next_steps____Retrieving_the_I_g4aqfl.png)
...
2. Right-click on the `IRS_001.TXT` link and select “Save Link As.”
   ![IRS_001.TXT save example](https://res.cloudinary.com/ddvcsl4ya/image/upload/v1766288110/p62_r_CY2020_and_beyond__if_you_chose_the_ALL_option__ma0vel.png)
   > [!NOTE]
